...
<div class="col-sm-6 col-lg-4 mb-3 d-flex justify-content-center">
    <div class="card bg-gradient-primary text-white shadow-sm">
        ...
        <div class="card-footer d-flex align-items-center justify-content-between bg-dark text-white">
            <a class="small text-white stretched-link" href="cricketresult.php">Update result</a>
...
<div class="col-sm-6 col-lg-4 mb-3 d-flex justify-content-center">
    <div class="card bg-gradient-primary text-white shadow-sm">
        ...
        <div class="card-footer d-flex align-items-center justify-content-between bg-dark text-white">
            <a class="small text-white stretched-link" href="badmintonresult.php">update result</a>
            <div class="small text-white"><i class="fas fa-angle-right"></i></div>
        </div>
    </div>
</div>
...
<div class="col-sm-6 col-lg-4 mb-3 d-flex justify-content-center">
    <div class="card bg-gradient-primary text-white shadow-sm">
        ...
        <div class="card-footer d-flex align-items-center justify-content-between bg-dark text-white">
            <a class="small text-white stretched-link" href="tabletennisresult.php">update result</a>
            <div class="small text-white"><i class="fas fa-angle-right"></i></div>
        </div>
    </div>
</div>
...
<div class="col-sm-6 col-lg-4 mb-3 d-flex justify-content-center">
    <div class="card bg-gradient-primary text-white shadow-sm">
        ...
        <div class="card-footer d-flex align-items-center justify-content-between bg-dark text-white">
            <a class="small text-white stretched-link" href="volleyballresult.php">update result</a>
            <div class="small text-white"><i class="fas fa-angle-right"></i></div>
        </div>
    </div>
</div>
