...
?>
<?php
$queryLatest = mysqli_query($con, "SELECT event_name FROM events ORDER BY start_date DESC LIMIT 1");
$latestEventRow = mysqli_fetch_assoc($queryLatest);
$latestEvent = $latestEventRow ? $latestEventRow['event_name'] : "No Event Available";
?>
        ...
        <div id="layoutSidenav">
          <?php include ('includes/sidebar.php');?>
            <div id="layoutSidenav_content">
                <main>
                <h1 class="mt-4">EVENT RESULTS</h1>
