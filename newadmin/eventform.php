...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO events (event_name, start_date, end_date, event_location, sport) 
            VALUES ('$event_name', '$start_date', '$end_date', '$event_location', '$sport')";
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card mb-4 mx-auto event-card">
                       ...
                       <form id="eventForm" onsubmit="return validateForm()" method="POST">

                        <label>Event Name:</label>
                        <input type="text" class="form-control" id="event_name" name="event_name" required oninput="checkEventName()"><br>
                        <small id="eventNameError" style="color: red;"></small><br>
